...
export function InstallCommand() {
  ...
  return (
    <div className="relative group rounded-lg bg-gray-950 dark:bg-gray-900 border border-gray-800 dark:border-gray-700 px-5 py-4 flex items-center gap-4">
      <code className="flex-1 font-mono text-sm text-green-400 select-all break-all">
        {INSTALL_CMD}
      </code>
      <button
        onClick={handleCopy}
